...
def start():
    ...
    while not input_.isnumeric():
        input_ = input("Please input a number: ")
    
    # Convert the string number input to the integer value
    input_time = int(input_)

    # The else-if operator determines the timetable.
    if input_time > 24:
        print("Wrong input! Please input numbers 1 to 24")
    else:
